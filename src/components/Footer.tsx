    ...
    <footer className="grid grid-cols-3 gap-4 pb-8 pt-16">
      <div className="text-center">
        ...
        <p>
          ...
          Magnam minima maxime possimus nobis beatae modi, ab eveniet laborum
          cum sunt?
        </p>
      </div>
      <div className="text-center">
        ...
        <p>
          ...
          soluta, dolorum iusto error id aspernatur dicta ratione. Corrupti
      ...
      <div className="text-center">
        ...
        <p>
          ...
          Deleniti aliquid quam assumenda quasi sit quos at culpa eum unde illo.
        </p>
      </div>
    </footer>
  )
